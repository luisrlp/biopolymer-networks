...
class Generator:
    ...
    def __init__(self, seed: int  = None, size: int  = None) -> None:
        """
    ...
    def integer_in_interval(self, low: int = 0, high: int = 3) -> np.ndarray:
        """
    ...
    def float_in_interval(self, a: float = 0, b: float = 180, interval: float = 5) -> np.ndarray:
        """
    ...
    def normal(self, loc: float, scale: float, size : int = None) -> np.ndarray:
        """
        ...
        """
        return np.random.normal(loc, scale, size=size if size is not None else self.size)
    ...
    def lognormal(self, mean: float, sigma: float) -> np.ndarray:
        ...
        return np.random.lognormal(mu, sigma, size=self.size)
