...
1. $\bar{\gamma}_1 = 2 \left(\frac{\partial \Psi_{\mathrm{iso}}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_1}+\bar{I}_1 \frac{\partial \Psi_{\mathrm{iso}}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_2}\right)$
11. $$\bar{\gamma}_1=2\left(\frac{\partial \Psi_{\mathrm{iso}}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_1}+\bar{I}_1 \frac{\partial \Psi_{\mathrm{iso}}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_2}\right) = 2(\mathrm{diso}(1)+\bar{I}_1\mathrm{diso}(2))$$
