...
5. ll - Filament contour length [$\mu$m]
6. r0f - Filament initial end-to-end distance [$\mu$m]
7. r0c - Crosslinker (CL) initial end-to-end distance [$\mu$m]
...
13. nn - Isotropic filaments per unit volume [$\mu$ m $^{-3}$]
...
1. $\bar{\gamma}_1=2\left(\frac{\partial \Psi_{\text {iso }}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_1}+\bar{I}_1 \frac{\partial \Psi_{\text {iso }}\left(\bar{I}_1 ; \bar{I}_2\right)}{\partial \bar{I}_2}\right) = 2(\mathrm{diso}(1)+\bar{I}_1\mathrm{d iso}(2))$
